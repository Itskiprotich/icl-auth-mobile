...
android {
  namespace = "icl.ohs.libs.starter.app"
  compileSdk = libs.versions.android.compileSdk.get().toInt()

  defaultConfig {
    applicationId = "icl.ohs.libs.starter.app"
...
compose.desktop {
  application {
    mainClass = "icl.ohs.libs.starter.app.MainKt"

    nativeDistributions {
      targetFormats(TargetFormat.Dmg, TargetFormat.Msi, TargetFormat.Deb, TargetFormat.Rpm)
      packageName = "icl.ohs.libs.starter.app"
