...
import icl.ohs.libs.starter.app.feature.web.WebContentScreen
  ...
  NavHost(navController = navController, startDestination = AUTH_LOGIN_ROUTE) {
    ...
    composable(
      ...
      ForgotPasswordScreen(
        ...
        initialIdNumber = initialIdentifier,
        onIAlreadyHaveCodeClick = { idNumber ->
          navController.navigateToResetPassword(identifier = idNumber)
        },
